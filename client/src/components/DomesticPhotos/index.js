...
function EngagementPhotos() {
  return(
    <div className="row">
      ...
      <div className="column">
        <img src="../images/domestic/FB_IMG_1543580704941.jpg" />
        <img src="../images/domestic/FB_IMG_1582161998577.jpg" />
      ...
      <div className="column">
        <img src="../images/domestic/GOPR0153.JPG" />
        <img src="../images/domestic/IMG_7186.JPG" />
